...
public class RelationOverTopicsFactory {
    public static TopicRelations getTopicRelationsEntity(RelationType relationType) throws RelationNotFound {
        ...
        } else if (relationType == RelationType.ContributeTo) {
            return new ContributeTo((relationType));
        } else if (relationType == RelationType.EquivalentTo) {
            return new EquivalentTo(RelationType.EquivalentTo);
        } else {
